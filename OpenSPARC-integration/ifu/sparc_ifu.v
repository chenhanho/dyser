...
module sparc_ifu (/*AUTOARG*/
   ...
   dyser_ifu_stallreq,        // stall request
   ifu_dyser_rollback_e,      // rollback dyser inst at e stage
   ifu_dyser_rollback_w,      // rollback dyser inst at w stage
   ifu_dyser_ld_d,              // dyser load
   ifu_dyser_st_d,              // dyser store
   ifu_dyser_vec_d,             // dyser vector interface
   // **
   // Inputs
   ...
   // ** DySER specific signals **
   input                dyser_ifu_stallreq;        // stall request
   output               ifu_dyser_rollback_e;      // rollback from e 
   output               ifu_dyser_rollback_w;      // rollback from w
...
//		      /*AUTOINST*/);
   ...
   sparc_ifu_dec dec(
			...
			/*AUTOINST*/
                     ...
                     .ifu_dyser_ld_d(ifu_dyser_ld_d),  // dyser load
                     .ifu_dyser_st_d(ifu_dyser_st_d),  // dyser store
                     .ifu_dyser_vec_d(ifu_dyser_vec_d),  // dyser load
                     // **
                     // Inputs
                     .rclk              (rclk),
                     .se                (se),
