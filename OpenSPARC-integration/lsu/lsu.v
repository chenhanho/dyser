...
// **DySER specific signals**
output                  lsu_dyser_ldst_miss_w;
input [63:0]            dyser_lsu_data_e;
input                   dyser_lsu_st_e;
// **
...
// **DySER specific signals**
  // mux logic to select dyser data
  wire [63:0] exu_lsu_rs3_dyser_data_e;
  wire        dyser_lsu_st_e;

  assign exu_lsu_rs3_dyser_data_e = dyser_lsu_st_e ? dyser_lsu_data_e : exu_lsu_rs3_data_e;
...
lsu_stb_rwdp  stb_rwdp  (
                         ...
                         .rst_tri_en    (mux_drive_disable),     // Templated
                         // **DySER specific signals**
                         .exu_lsu_rs3_data_e(exu_lsu_rs3_dyser_data_e[63:0]),
                         // **
                         .lsu_stb_data_early_sel_e(lsu_stb_data_early_sel_e[3:0]),
                         .lsu_stb_data_final_sel_m(lsu_stb_data_final_sel_m),
