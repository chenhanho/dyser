...
/* switch 0 wires */
wire [`PATH_WIDTH:0] d_0_1, d_1_0, d_0_6, d_6_0;
wire c_0_1, c_1_0, c_0_6, c_6_0;

switch #(100, 1, `EAST, `WEST) s0(
  /* inputs */
  .d_in_NW(d_in_i11),
...
/* switch 8 wires */
wire [`PATH_WIDTH:0] d_8_9, d_9_8;
wire c_8_9, c_9_8;

switch #(108, 1, `SOUTH, `EAST) s8(
  /* inputs */
  .d_in_NW(d_in_i5),
  .d_in_N(d_7_8),
  .d_in_E(d_in_t7),
