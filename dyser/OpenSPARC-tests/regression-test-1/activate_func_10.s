	...
	.align 8
.LLC0:
	.asciz	"Activate Func 10 Test failed: %d (expected: %d)\n"
	.align 8
.LLC1:
	.asciz	"Activate Func 10 Test complete.\n"
	.section	".text"
	.align 4
	.global main
	.type	main, #function
...
main:
	...
	.word 0x81b88001  ! dyser_init 0x001001
	.word 0x87b80010  ! dyser_init 0x030010
	.word 0x89b80210  ! dyser_init 0x040050
	.word 0x81b82000  ! dyser_init 0x000400
	.word 0x81bc0000  ! dyser_init 0x008000
	.word 0xa1bc0008  ! dyser_init 0x108008
	.word 0x8bb80009  ! dyser_init 0x050009
	.word 0x89b81000  ! dyser_init 0x040200
	.word 0x81b80010  ! dyser_init 0x000010
	mov	%g0, %g1
	mov	1, %g2
